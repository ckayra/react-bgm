...
class ClientiPage extends React.Component {
 ...
 columns = [
	 ...
	 { title: '',field: 'fScaduto',	maxWidth: 40, align:'center', render: (val) => val==="S" ? <i className="material-icons icona-scaduto">report_problem</i> : "" },
	 { title: 'scaduto',	field: 'scaduto',	maxWidth: 100, align:'right', render: (val) => val==="0,00" ? '' : val }
]
	...
	render() {
		return (
			...
			<Table
				...
				filter
				sort={[{field:'fScaduto',order: 'desc'},{field:'ragSociale12', order:'asc'}]}
			/>
